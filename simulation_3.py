...
if __name__ == '__main__':
    ...
    for i in range(3):
        priority = 0
        host_1.udt_send('H3', 'MESSAGE_'+str(i)+'_FROM_H1', priority)
        print("Sending message from H1 to H3 with priority %d: \"MESSAGE_%d_FROM_H1\"" % (priority, i))
        priority = 1
        host_2.udt_send('H3', 'MESSAGE_'+str(i)+'_FROM_H2', priority)
        print("Sending message from H2 to H3 with priority %d: \"MESSAGE_%d_FROM_H2\"\n" % (priority, i))
